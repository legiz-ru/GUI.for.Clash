export default {
  ...
  kernel: {
    ...
    'lgbm-auto-update': 'LightGBM auto update',
    'lgbm-update-interval': 'LightGBM update interval',
    'lgbm-url': 'LightGBM model URL',
    'smart-collector-size': 'Smart collector size',
    ...
    proxyGroups: {
      ...
      uselightgbm: 'Use LightGBM prediction',
      collectdata: 'Collect data for model training',
      'sample-rate': 'Sample rate',
      'prefer-asn': 'Prefer ASN',
