export default {
  ...
  kernel: {
    ...
    'lgbm-auto-update': 'LightGBM 模型自动更新',
    'lgbm-update-interval': 'LightGBM 更新间隔',
    'lgbm-url': 'LightGBM 模型地址',
    'smart-collector-size': '智能采集文件大小',
    ...
    proxyGroups: {
      ...
      uselightgbm: '启用 LightGBM 权重预测',
      collectdata: '采集数据用于模型训练',
      'sample-rate': '采样率',
      'prefer-asn': '优先匹配 ASN',
